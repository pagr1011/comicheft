...
CREATE INDEX IF NOT EXISTS comicheft_isbn_idx ON comicheft(isbn);

CREATE TABLE IF NOT EXISTS titel (
    id          INTEGER PRIMARY KEY AUTOINCREMENT,
    titel       TEXT NOT NULL,
    untertitel  TEXT,
    comicheft_id     INTEGER NOT NULL UNIQUE REFERENCES comicheft
);
...
CREATE INDEX IF NOT EXISTS abbildung_comicheft_id_idx ON abbildung(comicheft_id);
