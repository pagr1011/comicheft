...
export type ComicheftUpdateDTO = Omit<
    Comicheft,
    'aktualisiert' | 'erzeugt' | 'id' | 'schlagwoerter' | 'version'
>;
...
export class ComicheftWriteController {
    ...
    @ApiBadRequestResponse({ description: 'Fehlerhafte Comicheft-Daten' })
    async create(
    ...
    async update(
        @Body() comicheftDTO: ComicheftUpdateDTO,
        @Param('id') id: string,
        ...
        const result = await this.#service.update(
            id,
            this.#updateDtoToComicheft(comicheftDTO),
            version,
        );
    ...
    #dtoToComicheft(comicheftDTO: ComicheftDTO): Comicheft {
        ...
        // Rueckwaertsverweis von Schlagwort zu Comicheft
    ...
    #updateDtoToComicheft(comicheftDTO: ComicheftUpdateDTO): Comicheft {
        const comicheft: Comicheft = {
            id: undefined,
            version: undefined,
            titel: comicheftDTO.titel,
